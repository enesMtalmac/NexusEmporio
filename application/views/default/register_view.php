...
<!-- breadcrumb start -->
<div class="breadcrumb-area" style="background-image:url('<?php echo base_url();?>/default/assets/img/breadcrumb/2.png')">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="sign-in-area">
                    ...
                    <form method="POST" class="contact-form-wrap" id="registerform" onsubmit="return false;">
                        ...
                        <div class="single-input-wrap input-group">
                            ...
                            <input name="lastname" id="inp-1" type="text" class="form-control" placeholder="Soyadınız">
                        </div>
                        <div class="single-input-wrap input-group">
                            <label for="inp-1phone">Telefon Numaranız</label>
                            <input name="phone" id="inp-1phone" type="text" class="form-control" placeholder="Telefon Numaranız">
                        </div>
                        <div class="single-input-wrap input-group">
                        ...
                        <div class="single-input-wrap input-group">
                            ...
                            <input name="pass" id="inp-2" type="password" class="form-control" placeholder="Şifreniz">
                        </div>
