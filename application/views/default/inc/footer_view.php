        ...
        <div class="container">
            <div class="row">
                ...
                <div class="logo">
                    ...
                    <img width="200" height="300" src="<?php echo base_url('uploads/'.$setting->footerlogo);?>" alt="<?php echo $setting->site_baslik;?>">
                    </a>
                </div>
                </div>
            </div>
    ...
    <script src="<?php echo base_url();?>/default/assets/js/custom.js?v=1234567<?php echo time();?>"></script>
