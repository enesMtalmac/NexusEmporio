                    ...
                    <div class="sidebar-area">
                        <div class="widget widget-cart">
                            <div class="widget-cart-inner text-center">
                                ...
                                <ul>
                                    <li><input id="eft" type="radio" name="payment" value="eft" /> <label for="eft">Havale/EFT</label></li>
                                </ul>
                                ...
                                <button id="savebutton" onclick="ordersave();" type="submit" class="btn btn-base">Satın Al</button>
                            </div>
                        </div>
                    </div>
                </form>
