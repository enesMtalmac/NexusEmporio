                                            ...
                                            <div class="all-isotope-item">
                                                <div >
                                                    <a class="gallery-fancybox" href="javascript:void(0);">
                                                        <img width="300" height="300" src="<?php echo base_url('uploads/'.$pimage->resdosya);?>" alt="<?php echo $product->urun_adi;?>">
                                                    </a>
                            ...
                            <div class="all-isotope-item">
                                <div class="thumb">
                                    <a class="gallery-fancybox" href="<?php echo base_url('products/detail/'.$rel->urun_sef.'/'.$rel->urun_kodu);?>">
                                        <img width="300" height="400" src="<?php echo base_url('uploads/'.$rel->urun_resim);?>" alt="<?php echo $rel->urun_adi;?>">
                                    </a>
